...
const Testimonials = () => {
  return (
    <div className='flex flex-col items-center justify-center my-24 py-12 md:px-28'>
                ...
                <div key={index} className='bg-white/20 p-12 rounded-lg shadow-md order w-80 m-auto cursor-pointer hover:scale-[1.02] transition-all'>
                    <div className='flex flex-col items-center'>
                        ...
                        <div className='flex mb-4'>
                            {Array(testimonial.stars).fill().map((item, index)=>(<img className='' key={index} src={assets.rating_star} />))}
